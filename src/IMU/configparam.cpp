...
namespace ORB_SLAM2
{
    ...
    bool ConfigParam::_bRealTime =false; //true;
    ...
    ConfigParam::ConfigParam(std::string configfile)
    {
        ...
        fSettings["imufile"] >> _imufile;
        std::cout<<"imufile: "<<_imufile<<std::endl;

        fSettings["imagefile"] >> _imagefile;
        std::cout<<"imagefile: "<<_imagefile<<std::endl;
        fSettings["timefile"] >> _timefile;
        std::cout<<"timefile: "<<_timefile<<std::endl;

        _nphoto1 = fSettings["nphoto1"];
        _nphoto2 = fSettings["nphoto2"];
	_DatasetSource = fSettings["DatasetSource"];
	std::cout<<"nphoto1: "<<_nphoto1<<std::endl;
	std::cout<<"nphoto2: "<<_nphoto2<<std::endl;
