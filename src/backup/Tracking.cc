    ...
    mpFrameDrawer(pFrameDrawer), mpMapDrawer(pMapDrawer), mpMap(pMap), mnLastRelocFrameId(0)
{
    ...
    mpParams = pParams;
    R_and_T.open("/home/hmx/LearnVIORB/Data/weSlam_R_and_T.txt",ofstream::binary);
...
void Tracking::Track()
{
    ...
    else
    {
        ...
        if(!mbOnlyTracking)
        {
            ...
            if(mState==OK)
            {
                ...
                if(mpLocalMapper->GetVINSInited())
                {
                   ...
                   // cout<< "Visual-Inertial initialized"<<endl;
...
#endif
                {
                    //cout<< "If Visual-Inertial not initialized, keep the same as pure-vslam"<<endl;
        ...
        if(!mbOnlyTracking)
        {
            ...
            if(bOK)
            {
                ...
                else
                {
                    ...
                    {
                        //cout<<"TrackLocalMapWithIMU"<<endl;
        ...
        if(bOK)
        {
            ...
            if(mbRelocBiasPrepare)
            {
                ...
                cout<< "Use 20 consecutive frames to re-compute IMU bias"<<endl;
        ...
        if(bOK)
        {
            ...
            {
                cout<<"mLastFrame.mTcw.empty()"<<endl;
                mVelocity = cv::Mat();
            }
           ...
           //cout<<mCurrentFrame.mTimeStamp<<endl;
            ...
            //ostringstream s1;
            //s1<<111111111233.131313131313;
            R_and_T<<setprecision(20)<<mCurrentFrame.mTimeStamp<<endl;
            R_and_T<<mCurrentFrame.mTcw<<endl;
            // Clean VO matches
            for(int i=0; i<mCurrentFrame.N; i++)
            {
                MapPoint* pMP = mCurrentFrame.mvpMapPoints[i];
            ...
            {
                //cout<< "insert a new keyframe"<<endl;
                CreateNewKeyFrame();
            }
            // Clear flag
    ...
    else
    {
        ...
        cout << "This can happen if tracking is lost" << endl;
...
void Tracking::CreateInitialMapMonocular()
{
    ...
    if(medianDepth<0 || pKFcur->TrackedMapPoints(1)<100/*100*/)
    {
